...
SYS = (
    ...
    "snippets contradict.\n"
    "Never invent facts, and do not answer from your own memory — call a tool and answer from its "
    "output, even for a general or conceptual cricket question. Prefer cricket_rules over cricket_prose for anything about how the game "
